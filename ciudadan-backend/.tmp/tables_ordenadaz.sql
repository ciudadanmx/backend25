...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS admin_permissions (id SERIAL PRIMARY KEY, action varchar(255) NULL, action_parameters json NULL, subject varchar(255) NULL, properties json NULL, conditions json NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS admin_users (id SERIAL PRIMARY KEY, firstname varchar(255) NULL, lastname varchar(255) NULL, username varchar(255) NULL, email varchar(255) NULL, password varchar(255) NULL, reset_password_token varchar(255) NULL, registration_token varchar(255) NULL, is_active boolean NULL, blocked boolean NULL, prefered_language varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS admin_roles (id SERIAL PRIMARY KEY, name varchar(255) NULL, code varchar(255) NULL, description varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS strapi_api_tokens (id SERIAL PRIMARY KEY, name varchar(255) NULL, description varchar(255) NULL, type varchar(255) NULL, access_key varchar(255) NULL, last_used_at timestamp NULL, expires_at timestamp NULL, lifespan bigint NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS strapi_api_token_permissions (id SERIAL PRIMARY KEY, action varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS strapi_transfer_tokens (id SERIAL PRIMARY KEY, name varchar(255) NULL, description varchar(255) NULL, access_key varchar(255) NULL, last_used_at timestamp NULL, expires_at timestamp NULL, lifespan bigint NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS strapi_transfer_token_permissions (id SERIAL PRIMARY KEY, action varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS files (id SERIAL PRIMARY KEY, name varchar(255) NULL, alternative_text varchar(255) NULL, caption varchar(255) NULL, width integer NULL, height integer NULL, formats json NULL, hash varchar(255) NULL, ext varchar(255) NULL, mime varchar(255) NULL, size float NULL, url varchar(255) NULL, preview_url varchar(255) NULL, provider varchar(255) NULL, provider_metadata json NULL, folder_path varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS upload_folders (id SERIAL PRIMARY KEY, name varchar(255) NULL, path_id integer NULL, path varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS strapi_releases (id SERIAL PRIMARY KEY, name varchar(255) NULL, released_at timestamp NULL, scheduled_at timestamp NULL, timezone varchar(255) NULL, status varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS strapi_release_actions (id SERIAL PRIMARY KEY, type varchar(255) NULL, target_id integer NULL, target_type varchar(255) NULL, content_type varchar(255) NULL, locale varchar(255) NULL, is_entry_valid boolean NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS i18n_locale (id SERIAL PRIMARY KEY, name varchar(255) NULL, code varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS up_permissions (id SERIAL PRIMARY KEY, action varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS up_roles (id SERIAL PRIMARY KEY, name varchar(255) NULL, description varchar(255) NULL, type varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS up_users (id SERIAL PRIMARY KEY, username varchar(255) NULL, email varchar(255) NULL, provider varchar(255) NULL, password varchar(255) NULL, reset_password_token varchar(255) NULL, confirmation_token varchar(255) NULL, confirmed boolean NULL, blocked boolean NULL, roles json NULL, prueba text NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, id_stripe varchar(255) null, fecha_registro timestamp null, membresia_vigente boolean null, tipo_membresia varchar(255) null, fecha_nacimiento timestamp null, fecha_membresia timestamp null, telefono varchar(255) null, cp varchar(255) null, nombre_completo varchar(255) null, fecha_fin_membresia_actual date null, stripe_customer_id varchar(255) null, stripe_subscription_id varchar(255) null, stripe_price_id varchar(255) null, subscription_status varchar(255) null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS as (id SERIAL PRIMARY KEY, a varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS carteras (id SERIAL PRIMARY KEY, laborys_ganados float NULL, laborys_saldo float NULL, ciudadan_tokens float NULL, ciudadan_rendimientos float NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS driver_locations (id SERIAL PRIMARY KEY, coords json NULL, time timestamp NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS gen_wallets (id SERIAL PRIMARY KEY, wallet_idx varchar(255) NULL, coin varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS messages (id SERIAL PRIMARY KEY, text text NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, timestamp timestamp null, status varchar(255) null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS world_coin_wallets (id SERIAL PRIMARY KEY, cartera_idx varchar(255) NULL, ammount float NULL, genesis boolean NULL, user_id varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS admin_permissions_role_links (id SERIAL PRIMARY KEY, permission_id integer NULL, role_id integer NULL, permission_order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS admin_users_roles_links (id SERIAL PRIMARY KEY, user_id integer NULL, role_id integer NULL, role_order float NULL, user_order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS strapi_api_token_permissions_token_links (id SERIAL PRIMARY KEY, api_token_permission_id integer NULL, api_token_id integer NULL, api_token_permission_order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS strapi_transfer_token_permissions_token_links (id SERIAL PRIMARY KEY, transfer_token_permission_id integer NULL, transfer_token_id integer NULL, transfer_token_permission_order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS files_related_morphs (id SERIAL PRIMARY KEY, file_id integer NULL, related_id integer NULL, related_type varchar(255) NULL, field varchar(255) NULL, order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS files_folder_links (id SERIAL PRIMARY KEY, file_id integer NULL, folder_id integer NULL, file_order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS upload_folders_parent_links (id SERIAL PRIMARY KEY, folder_id integer NULL, inv_folder_id integer NULL, folder_order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS strapi_release_actions_release_links (id SERIAL PRIMARY KEY, release_action_id integer NULL, release_id integer NULL, release_action_order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS up_permissions_role_links (id SERIAL PRIMARY KEY, permission_id integer NULL, role_id integer NULL, permission_order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS up_users_role_links (id SERIAL PRIMARY KEY, user_id integer NULL, role_id integer NULL, user_order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS carteras_user_id_links (id SERIAL PRIMARY KEY, cartera_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS driver_locations_driver_id_links (id SERIAL PRIMARY KEY, driver_location_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS messages_sender_id_links (id SERIAL PRIMARY KEY, message_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS messages_receiver_id_links (id SERIAL PRIMARY KEY, message_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS world_coin_wallets_user_idd_links (id SERIAL PRIMARY KEY, world_coin_wallet_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS clubs (id SERIAL PRIMARY KEY, nombre_club varchar(255) NULL, direccion json NULL, lat float NULL, lng float NULL, nombre_titular varchar(255) NULL, status_legal integer NULL, archivos_legal json NULL, descripcion text NULL, servicios json NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, locale varchar(255) NULL, auth_name varchar(255) null, horarios json null, whatsapp varchar(255) null, activo boolean null, tipo varchar(255) null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS clubs_localizations_links (id SERIAL PRIMARY KEY, club_id integer NULL, inv_club_id integer NULL, club_order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS clubs_users_permissions_user_links (id SERIAL PRIMARY KEY, club_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS stores_users_permissions_user_links (id SERIAL PRIMARY KEY, store_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS stores_localizations_links (id SERIAL PRIMARY KEY, store_id integer NULL, inv_store_id integer NULL, store_order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS store_categories (id SERIAL PRIMARY KEY, nombre varchar(255) NULL, descripcion text NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, slug varchar(255) null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS productos_store_category_links (id SERIAL PRIMARY KEY, producto_id integer NULL, store_categorie_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS productos_store_links (id SERIAL PRIMARY KEY, producto_id integer NULL, store_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS stores (id SERIAL PRIMARY KEY, name varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, locale varchar(255) NULL, email varchar(255) NULL, published_at timestamp null, stripe_account_id varchar(255) null, stripe_onboarded boolean null, stripe_charges_enabled boolean null, stripe_payouts_enabled boolean null, terminado boolean null, slug varchar(255) null, cp varchar(255) null, localidad varchar(255) null, esquema_impuestos varchar(255) null, paso integer null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS components_carritos_producto_en_carritos_producto_links (id SERIAL PRIMARY KEY, producto_en_carrito_id integer NULL, producto_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS carritos (id SERIAL PRIMARY KEY, total float NULL, estado varchar(255) NULL, ultima_actualizacion timestamp NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, log json null, total_envios float null, agrupacion_de_envios json null, usuario_email varchar(255) null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS carritos_components (id SERIAL PRIMARY KEY, entity_id integer NULL, component_id integer NULL, component_type varchar(255) NULL, field varchar(255) NULL, order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS carritos_usuario_links (id SERIAL PRIMARY KEY, carrito_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS resenas (id SERIAL PRIMARY KEY, comentario text NULL, timestamp timestamp NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, status varchar(255) null, observaciones text null, tipo varchar(255) null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS resenas_usuario_links (id SERIAL PRIMARY KEY, resena_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS resenas_producto_links (id SERIAL PRIMARY KEY, resena_id integer NULL, producto_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS resenas_carrito_links (id SERIAL PRIMARY KEY, resena_id integer NULL, carrito_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS notificaciones (id SERIAL PRIMARY KEY, cuerpo json NULL, user_email varchar(255) NULL, timestamp timestamp NULL, leida boolean NULL, status varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, tipo varchar(255) null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS categorias_cursos (id SERIAL PRIMARY KEY, nombre varchar(255) NULL, nivel integer NULL, sup integer NULL, descripcion text NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, slug varchar(255) null, activa boolean null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS publicaciones (id SERIAL PRIMARY KEY, contenido json NULL, timestamp timestamp NULL, publicado varchar(255) NULL, uid varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS publicaciones_autor_links (id SERIAL PRIMARY KEY, publicacion_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS direcciones_store_id_links (id SERIAL PRIMARY KEY, direccion_id integer NULL, store_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS direcciones_event_id_links (id SERIAL PRIMARY KEY, direccion_id integer NULL, evento_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS up_users_direcciones_links (id SERIAL PRIMARY KEY, user_id integer NULL, direccion_id integer NULL, direccion_order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS comentarios_publicaciones (id SERIAL PRIMARY KEY, comentario text NULL, timestamp timestamp NULL, status varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, respuesta boolean null, tipo varchar(255) null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS comentarios_publicaciones_autor_links (id SERIAL PRIMARY KEY, comentario_publicacion_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS resenas_curso_id_links (id SERIAL PRIMARY KEY, resena_id integer NULL, curso_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS resenas_club_id_links (id SERIAL PRIMARY KEY, resena_id integer NULL, club_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS carritos_direccion_links (id SERIAL PRIMARY KEY, carrito_id integer NULL, direccion_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS comentarios_publicaciones_publicacion_id_links (id SERIAL PRIMARY KEY, comentario_publicacion_id integer NULL, publicacion_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS cursos_maestro_links (id SERIAL PRIMARY KEY, curso_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS cursos_ubicacion_links (id SERIAL PRIMARY KEY, curso_id integer NULL, direccion_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS eventos_creador_links (id SERIAL PRIMARY KEY, evento_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS eventos_direccion_links (id SERIAL PRIMARY KEY, evento_id integer NULL, direccion_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS notificaciones_usuario_links (id SERIAL PRIMARY KEY, notificacion_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS comentarios_publicaciones_comentario_id_links (id SERIAL PRIMARY KEY, comentario_publicacion_id integer NULL, inv_comentario_publicacion_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS resenas_evento_id_links (id SERIAL PRIMARY KEY, resena_id integer NULL, evento_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS configuraciones_usuarios (id SERIAL PRIMARY KEY, email varchar(255) NULL, configuraciones json NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS configuraciones_usuarios_usuario_links (id SERIAL PRIMARY KEY, configuracion_usuario_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS enlaces_autor_links (id SERIAL PRIMARY KEY, enlace_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS listas_suscripciones (id SERIAL PRIMARY KEY, tipo varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS listas_suscripciones_suscritos_links (id SERIAL PRIMARY KEY, lista_suscripcion_id integer NULL, user_id integer NULL, user_order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS listas_suscripciones_curso_links (id SERIAL PRIMARY KEY, lista_suscripcion_id integer NULL, curso_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS listas_suscripciones_evento_links (id SERIAL PRIMARY KEY, lista_suscripcion_id integer NULL, evento_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS reacciones (id SERIAL PRIMARY KEY, listado json NULL, tipo varchar(255) NULL, comentario boolean NULL, respuesta boolean NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS reacciones_evento_id_links (id SERIAL PRIMARY KEY, reaccion_id integer NULL, evento_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS reacciones_enlace_id_links (id SERIAL PRIMARY KEY, reaccion_id integer NULL, enlace_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS reacciones_comentario_id_links (id SERIAL PRIMARY KEY, reaccion_id integer NULL, comentario_publicacion_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS categorias_enlaces (id SERIAL PRIMARY KEY, titulo varchar(255) NULL, descripcion text NULL, nivel integer NULL, sup integer NULL, activa boolean NULL, slug varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS categorias_eventos (id SERIAL PRIMARY KEY, titulo varchar(255) NULL, descripcion text NULL, nivel integer NULL, sup integer NULL, slug varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, activa boolean null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS categorias_herramientas (id SERIAL PRIMARY KEY, titulo varchar(255) NULL, descripcion text NULL, slug varchar(255) NULL, nivel integer NULL, sup integer NULL, activa boolean NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS configuraciones_sistemas (id SERIAL PRIMARY KEY, basic_set json NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, datos_generales json null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS pedidos_components (id SERIAL PRIMARY KEY, entity_id integer NULL, component_id integer NULL, component_type varchar(255) NULL, field varchar(255) NULL, order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS pedidos_curso_id_links (id SERIAL PRIMARY KEY, pedido_id integer NULL, curso_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS pedidos_evento_id_links (id SERIAL PRIMARY KEY, pedido_id integer NULL, evento_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS pedidos_usuario_links (id SERIAL PRIMARY KEY, pedido_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS pedidos_direccion_origen_links (id SERIAL PRIMARY KEY, pedido_id integer NULL, direccion_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS pedidos_direccion_destino_links (id SERIAL PRIMARY KEY, pedido_id integer NULL, direccion_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS pedidos_carrito_id_links (id SERIAL PRIMARY KEY, pedido_id integer NULL, carrito_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS pedidos (id SERIAL PRIMARY KEY, tipo varchar(255) NULL, timestamp_creacion timestamp NULL, guia varchar(255) NULL, proveedor varchar(255) NULL, fecha_envio timestamp NULL, fecha_entrega timestamp NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, total_volumetrico float NULL, monto_envio float NULL, monto_total float NULL, fecha_pagado timestamp NULL, moneda varchar(255) NULL, status varchar(255) null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS components_carritos_producto_en_carritos (id SERIAL PRIMARY KEY, nombre varchar(255) NULL, precio_unitario float NULL, cantidad integer NULL, subtotal float NULL, envio float NULL, subtotal_volumetrico float NULL, esquema_impuestos varchar(255) NULL, cp varchar(255) null, total float null, comision_stripe float null, comision_plataforma float null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS pagos (id SERIAL PRIMARY KEY, idx varchar(255) NULL, tipo varchar(255) NULL, fecha_pagado timestamp NULL, monto float NULL, moneda varchar(255) NULL, stripe_payment_intent_id varchar(255) NULL, stripe_invoice_id varchar(255) NULL, stripe_customer_id varchar(255) NULL, stripe_subscription_id varchar(255) NULL, status varchar(255) NULL, descripcion varchar(255) NULL, metadata json NULL, disputa boolean NULL, metodo_pago varchar(255) NULL, observaciones text NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, pago_guia float null, pago_vendedor float null, comision_stripe float null, comision_plataforma float null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS pagos_carrito_id_links (id SERIAL PRIMARY KEY, pago_id integer NULL, carrito_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS pagos_curso_id_links (id SERIAL PRIMARY KEY, pago_id integer NULL, curso_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS pagos_evento_id_links (id SERIAL PRIMARY KEY, pago_id integer NULL, evento_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS pagos_usuario_links (id SERIAL PRIMARY KEY, pago_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS servicios (id SERIAL PRIMARY KEY, titulo varchar(255) NULL, descripcion text NULL, precio_fijo boolean NULL, precio float NULL, slug varchar(255) NULL, descripcion_precio text NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS servicios_prestador_links (id SERIAL PRIMARY KEY, servicio_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS enlaces_enlace_id_links (id SERIAL PRIMARY KEY, enlace_id integer NULL, inv_enlace_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS enlaces (id SERIAL PRIMARY KEY, titulo varchar(255) NULL, timestamp timestamp NULL, descripcion text NULL, calificacion integer NULL, calificaciones integer NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, status varchar(255) NULL, url varchar(255) NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS eventos_evento_id_links (id SERIAL PRIMARY KEY, evento_id integer NULL, inv_evento_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS pedidos_pago_id_links (id SERIAL PRIMARY KEY, pedido_id integer NULL, pago_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS stores_direccion_links (id SERIAL PRIMARY KEY, store_id integer NULL, direccion_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS contenidos (id SERIAL PRIMARY KEY, titulo varchar(255) NULL, slug varchar(255) NULL, contenido_libre json NULL, contenido_restringido json NULL, restringido boolean NULL, status varchar(255) NULL, tags text NULL, fecha_publicacion timestamp NULL, resumen varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, autor_email varchar(255) null, autor_nombre varchar(255) null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS contenidos_autor_links (id SERIAL PRIMARY KEY, contenido_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS direcciones_club_links (id SERIAL PRIMARY KEY, direccion_id integer NULL, club_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS productos (id SERIAL PRIMARY KEY, nombre varchar(255) NULL, descripcion varchar(255) NULL, precio float NULL, marca varchar(255) NULL, activo boolean NULL, destacado boolean NULL, store_id varchar(255) NULL, store_email varchar(255) NULL, stripe_product_id varchar(255) NULL, tags text NULL, fecha_creacion timestamp NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, stock float NULL, calificacion integer NULL, calificaciones integer NULL, vendidos integer NULL, cp varchar(255) NULL, slug varchar(255) NULL, largo float NULL, ancho float NULL, alto float NULL, peso float NULL, volumetrico float NULL, especificaciones json NULL, variaciones json NULL, localidad varchar(255) NULL, estado varchar(255) null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS components_carritos_producto_en_carritos_store_links (id SERIAL PRIMARY KEY, producto_en_carrito_id integer NULL, store_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS membresias (id SERIAL PRIMARY KEY, fecha_inicio date NULL, fecha_fin date NULL, plan varchar(255) NULL, monto_pagado float NULL, activa boolean NULL, miembro_desde timestamp NULL, observaciones varchar(255) NULL, status varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS membresias_usuario_links (id SERIAL PRIMARY KEY, membresia_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS categorias_contenidos (id SERIAL PRIMARY KEY, nombre varchar(255) NULL, activa boolean NULL, slug varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, descripcion varchar(255) null);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS contenidos_categoria_links (id SERIAL PRIMARY KEY, contenido_id integer NULL, categoria_contenido_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS pagos_store_links (id SERIAL PRIMARY KEY, pago_id integer NULL, store_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS preguntas_productos (id SERIAL PRIMARY KEY, pregunta text NULL, respuesta text NULL, fechapregunta timestamp NULL, fecharespuesta timestamp NULL, status varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS preguntas_productos_producto_links (id SERIAL PRIMARY KEY, pregunta_producto_id integer NULL, producto_id integer NULL, pregunta_producto_order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS preguntas_productos_usuario_links (id SERIAL PRIMARY KEY, pregunta_producto_id integer NULL, user_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS preguntas_productos_store_links (id SERIAL PRIMARY KEY, pregunta_producto_id integer NULL, store_id integer NULL, pregunta_producto_order float NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS direcciones (id SERIAL PRIMARY KEY, direccion json NULL, coords json NULL, cp varchar(255) NULL, ciudad varchar(255) NULL, estado varchar(255) NULL, observaciones varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, activa boolean NULL, user_email varchar(255) NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS cursos (id SERIAL PRIMARY KEY, titulo varchar(255) NULL, modalidad varchar(255) NULL, certificacion varchar(255) NULL, precio float NULL, descripcion text NULL, calendario_actividades json NULL, calificacion integer NULL, calificaciones integer NULL, temario json NULL, fecha_inicio timestamp NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, slug varchar(255) NULL, de_pago boolean NULL, enlace_reunion varchar(255) NULL, enlaces_publicos json NULL, enlaces_privados json NULL, status varchar(255) NULL, maestro_email varchar(255) NULL, maestro_nombre varchar(255) NULL, resumen varchar(255) NULL, tags varchar(255) NULL, restringido boolean NULL, fecha_publicacion timestamp NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS cursos_categoria_links (id SERIAL PRIMARY KEY, curso_id integer NULL, categoria_curso_id integer NULL);

CREATE TABLE IF NOT EXISTS IF NOT EXISTS eventos (id SERIAL PRIMARY KEY, titulo varchar(255) NULL, slug varchar(255) NULL, descripcion text NULL, colaboradores json NULL, de_pago boolean NULL, precio float NULL, ciudad varchar(255) NULL, estado varchar(255) NULL, multifecha boolean NULL, fecha_inicio date NULL, hora_inicio time NULL, fechas_horarios_adicionales json NULL, fecha_fin date NULL, hora_fin time NULL, modalidad varchar(255) NULL, status varchar(255) NULL, created_at timestamp NULL, updated_at timestamp NULL, published_at timestamp NULL, created_by_id integer NULL, updated_by_id integer NULL, url varchar(255) NULL);
